...
func (h _hostFunctions) Instantiate(ctx context.Context, r wazero.Runtime, ns wazero.Namespace) error {
	...
	envBuilder.NewFunctionBuilder().
		WithGoModuleFunction(api.GoModuleFunc(h._ShouldGreet), []api.ValueType{i32, i32}, []api.ValueType{i64}).
...
func (h _hostFunctions) _ShouldGreet(ctx context.Context, m api.Module, params []uint64) []uint64 {
